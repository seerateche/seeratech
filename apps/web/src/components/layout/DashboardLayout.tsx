...
const NAV_ITEMS: NavItem[] = [
  ...
  { label: 'عروض الاشتراك',    labelShort: 'العروض',   icon: Tag,              to: '/offers' },
...
export const DashboardLayout: React.FC<Props> = ({ children }) => {
  ...
  const SidebarInner = ({ inDrawer = false }) => (
    <aside
      className={[
        'flex flex-col h-full bg-surface-1/30 backdrop-blur-2xl border-l border-white/5 transition-all duration-200',
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-transparent" dir="rtl">
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        {/* Top bar */}
        <header className="h-14 bg-surface-1/30 backdrop-blur-2xl border-b border-white/5 flex items-center px-3 gap-2 flex-shrink-0 pt-safe"
